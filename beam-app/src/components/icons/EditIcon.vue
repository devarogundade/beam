<template>
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_128_2480)">
            <path
                ...
                stroke="#A2A2A2" stroke-width="1.3" stroke-linejoin="round" />
            <path d="M8.66699 2.6665L13.3337 7.33317" stroke="#A2A2A2" stroke-width="1.3" stroke-linejoin="round" />
            <path d="M9.3335 14.6665L14.6668 14.6665" stroke="#A2A2A2" stroke-width="1.3" stroke-linecap="round"
                stroke-linejoin="round" />
        </g>
        <defs>
            <clipPath id="clip0_128_2480">
