...
abstract contract PaymentRouter {
    IAaveV3 internal _aave;
    IUniswapV3 internal _uniswap;

    constructor(IAaveV3 aave_, IUniswapV3 uniswap_) {
        _aave = aave_;
        _uniswap = uniswap_;
    }
    ...
    function _routePayment(Params.RoutePayment memory params) internal {
        ...
        if (params.route == Enums.PaymentRoute.Uniswap) {
        ...
        } else if (params.route == Enums.PaymentRoute.Aave) {
