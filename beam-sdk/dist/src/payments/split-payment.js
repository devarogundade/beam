...
class OneTimePayment extends base_1.BasePayment {
    ...
    getPayment(params) {
        return this.client.request("POST", this.basePath, (0, queries_1.splitPaymentQuery)(params));
    }
    getPayments(params) {
        return this.client.request("POST", this.basePath, (0, queries_1.splitPaymentsQuery)(params));
    }
}
exports.OneTimePayment = OneTimePayment;
//# sourceMappingURL=split-payment.js.map